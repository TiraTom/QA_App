...
class SettingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Preferenceから表示名を取得してEditTextに表示させる
        val sp = getSharedPreferences(PreferenceKEY, Context.MODE_PRIVATE)
        var name = sp.getString(NameKEY, "")
        ...
        changeButton.setOnClickListener { v ->
            ...
            if (user == null) {
                ...
                Snackbar.make(v, "表示名を更新しました", Snackbar.LENGTH_LONG).show()
            }
        }
        ...
        logoutButton.setOnClickListener { v ->
            ...
            nameText.setText("")
            Snackbar.make(v, "サインアウトしました", Snackbar.LENGTH_LONG).show()
        }
    }
}
